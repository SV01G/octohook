--[[
    ...
    Preview system took me a couple hours to make but holy the amount of bug fixing is insane
...
-- Library functions 
    ...
    -- Preview Library Section  
        ...
        function Library:Preview(properties)
            local Cfg = {
                Items = {};
                CurrentTab;
                Section = self;
            ...
            local Items = Cfg.Items; do 
                Items.PreviewHolder = Library:Create( "TextButton" , {
                    Parent = self.Items.Elements;
                    Name = "\0";
                    Size = dim2(1, 0, 0, 0);
                    BorderColor3 = rgb(0, 0, 0);
                    ...
                    AutomaticSize = Enum.AutomaticSize.Y;
                    BackgroundColor3 = themes.preset.outline
                });	Library:Themify(Items.PreviewHolder, "outline", "BackgroundColor3")

                Library:Create( "UIPadding" , {
                    PaddingTop = dim(0, 1);
                    PaddingBottom = dim(0, 1);
                    Parent = Items.PreviewHolder;
                    PaddingRight = dim(0, 1);
                    PaddingLeft = dim(0, 1)
                });
        ...
        function Library:AddTab(properties)
            ...
            function Cfg.FlipPage()
                ...
                Items.Holder.Visible = true 
                    Items.Holder.Parent = self.Items.PreviewHolder
